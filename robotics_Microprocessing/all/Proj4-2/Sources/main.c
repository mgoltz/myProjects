...
// Project 4-2:  Ramp the motor from slow speed to full
//               speed in 1 second.  The ramping should
//               be smooth enough to be audibly unnoticeable
...
interrupt VectorNumber_Vtimmdcu void mdcuInterrupt () {
  ...
  static int i;
  static unsigned char steparray[] = {0xC4,0x86, 0x92, 0x13,0x31, 0x29, 0x68, 0x4C};
