...
void STATIONARY_TURN(int steps){
	...
	RAMP_BOTH_UP_REV(steps/4);
	HALF_STEP_REV(steps/2); //must ramp up and down individual wheels
    RAMP_BOTH_DOWN_REV(steps/4);
